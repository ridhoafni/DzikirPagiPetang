...
public class dzikirpagiActivity extends AppCompatActivity {
    ...
    private CardView cardview_ayatkursi, cardview_rekomendasiayat, cardview_bacaandzikir;
    private Intent i;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dzikirpagi);
        ...
        cardview_rekomendasiayat = (CardView) findViewById(R.id.cardview_rekomendasiayat);
        ...
        cardview_rekomendasiayat .setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        cardview_bacaandzikir .setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                i = new Intent(getApplicationContext(), bacaandzikirpagiActivity.class);
                startActivity(i);
            }
        });
    }
