...
public class AlarmdzikirpetangActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alarmdzikirpetang);
    ...
    private void openTimePickerDialog(boolean is24r) {
        ...
        timePickerDialog = new TimePickerDialog(AlarmdzikirpetangActivity.this,
